    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main id="main-content" className="relative pt-24 md:pt-28" tabIndex={-1}>
        ...
        <article id="blog-article" className="container relative z-10 mx-auto px-6 pb-24 md:pb-32">
          <div className="blog-article mx-auto">
            <Link
              to={blogsPath()}
              className="mb-10 inline-flex min-h-11 items-center gap-2 text-sm font-medium text-muted-foreground transition-colors hover:text-heading"
            >
            ...
            {post.cover && (
              <figure className="blog-article-cover relative mb-12 md:mb-16">
                <img
                  src={post.cover}
                  alt={post.coverAlt ?? ''}
                ...
                />
                {post.coverCredit && (
                  <figcaption className="absolute bottom-3 right-3 z-10 max-w-[min(calc(100%-1.5rem),20rem)] bg-heading/85 px-2.5 py-1 text-right text-[11px] font-medium leading-snug tracking-wide text-white">
                    Photo:{' '}
                    {post.coverCreditUrl ? (
                      <a
                        ...
                        className="underline decoration-white/45 underline-offset-[0.18em] hover:decoration-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-heading"
                      >
                        {post.coverCredit}
                      </a>
                    ) : (
